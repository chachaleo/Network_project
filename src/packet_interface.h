...
typedef enum {
    ...
    E_LENGTH = 22,       /* Erreur liee au champs Length  */
    E_CRC = 3,          /* CRC invalide */
    E_WINDOW = 4,       /* Erreur liee au champs Window */
    E_SEQNUM = 5,       /* Numero de sequence invalide */
    E_NOMEM = 6,        /* Pas assez de memoire */
    E_NOHEADER = 8,     /* Le paquet n'a pas de header (trop court) */
    E_UNCONSISTENT = 7, /* Le paquet est incoherent */
} pkt_status_code;
